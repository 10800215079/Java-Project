		function addMenuAndSubMenu() {
				...
				if (storedSubmenuAndMenu) {
					...
					submenuAndMenuData.forEach(function (menu) {
						...
						mainMenu.append('<a class="nav-link menu-link" href="#' + menu.menuMaster.menuId + '" data-bs-toggle="collapse" role="button" aria-expanded="true" aria-controls="sidebarDashboards"><i class="ri-dashboard-2-line"></i><span class="menu_id" data-value="' + menu.menuMaster.menuId + '">' + menu.menuMaster.menuName + '</span></a>');
