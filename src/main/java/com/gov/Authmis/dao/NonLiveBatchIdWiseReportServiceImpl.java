...
@Service
public class NonLiveBatchIdWiseReportServiceImpl implements NonLiveBatchIdWiseReportService{

        @PersistenceContext
        private EntityManager entityManager;

        @Override
        public HashMap<String, Object> getBatchIdsByDates(NonLiveBatchIdWiseReportModel nonLiveUploadListModel) {
